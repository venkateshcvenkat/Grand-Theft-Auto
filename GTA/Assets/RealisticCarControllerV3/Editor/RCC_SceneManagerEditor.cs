...
public class RCC_SceneManagerEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        EditorGUILayout.HelpBox("Scene manager that contains current camera vehicle, current camera camera, current camera UI Canvas, current camera character, recording/playing mechanim, and other vehicles as well.", MessageType.Info);
