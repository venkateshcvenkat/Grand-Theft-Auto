...
public class RCC_DashboardInputs : MonoBehaviour {
    ...
    public bool autoAssignVehicle = true;       //  Auto assign target vehicle as camera vehicle from the RCC_SceneManager.
    ...
    //  Variables of the camera vehicle.
    ...
    private void Update() {
        ...
        //  If no any camera vehicle, return.
        if (!vehicle)
            return;

        //  If camera vehicle is not controllable or controlled by AI, return.
        ...
        // Getting variables from the camera vehicle.
