...
public class RCC_Customization : MonoBehaviour {
    ...
    public static void SetCustomizationMode(RCC_CarControllerV3 vehicle, bool state) {
        ...
        if (!vehicle) {
            ...
            Debug.LogError("Player vehicle is not selected for customization! Use RCC_Customization.SetCustomizationMode(playerVehicle, true/false); for enabling / disabling customization mode for camera vehicle.");
            return;
