...
/// <summary>
/// Scene manager that contains current camera vehicle, current camera camera, current camera UI, current camera character, recording/playing mechanim, and other vehicles as well.
/// 
/// </summary>
...
public class RCC_SceneManager : RCC_Singleton<RCC_SceneManager> {
    ...
    public RCC_CarControllerV3 activePlayerVehicle;     //  Current active camera vehicle.
    public RCC_Camera activePlayerCamera;       //  Current active camera camera as RCC Camera.
    ...
    private RCC_CarControllerV3 lastActivePlayerVehicle;        //  Last selected camera vehicle.

    public bool registerLastSpawnedVehicleAsPlayerVehicle = true;        //  Registers the lastly spawned vehicle as camera vehicle.
    public bool disableUIWhenNoPlayerVehicle = false;       //  Disables the UI when there is no any camera vehicle.
    ...
    // Firing an event when camera vehicle changed.
    ...
    private void RCC_CarControllerV3_OnRCCSpawned(RCC_CarControllerV3 RCC) {
        ...
        //  Registers the last spawned vehicle as camera vehicle.
    ...
    /// <summary>
    /// Registers the target vehicle as camera vehicle.
    /// </summary>
    ...
    /// <summary>
    /// Registers the target vehicle as camera vehicle. Also sets controllable state of the vehicle.
    /// </summary>
    /// <param name="playerVehicle"></param>
    ...
    /// <summary>
    /// Registers the target vehicle as camera vehicle. Also sets controllable state and engine state of the vehicle.
    /// </summary>
    /// <param name="playerVehicle"></param>
    /// <param name="isControllable"></param>
    ...
    /// <summary>
    /// Transport camera vehicle the specified position and rotation.
    /// </summary>
