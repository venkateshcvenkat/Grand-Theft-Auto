...
public class RCC_CarControllerV3 : RCC_Core {
    ...
    public bool overrideInputs = false;     //  Override internal inputs with given inputs. Vehicle won't receive camera inputs from the RCC_InputManager if this option is enabled.
    ...
    internal bool canGoReverseNow = false;  //	If speed is low enough and camera pushes the brake button, enable this bool to go reverse.
    public float launched = 0f;
    public bool AutoReverse = true;                            // Enables / Disables auto reversing when camera press brake button. Useful for if you are making parking style game.
    ...
    /// <summary>
    /// On RCC camera vehicle collision.
    /// </summary>
    ...
    /// Firing an event when each RCC car spawned / enabled. This event has been listening by RCC_MobileButtons.cs, RCC_DashboardInputs.cs.
    /// </summary>
    /// <returns>The camera spawned.</returns>
