...
public class RCC_Camera : MonoBehaviour {
    ...
    //  Main camera target, which is our camera vehicle.
    [System.Serializable]
    ...
    public CameraTarget cameraTarget = new CameraTarget();      //  Target of the camera, which is our camera vehicle with custom class. Can be assigned manually with "SetTarget" method.
    ...
    public bool TPSAutoFocus = true;        // Auto focus to camera vehicle. Adjusts distance and height depends on vehicle bounds.
    public bool TPSAutoReverse = true;      // Auto reverse when camera vehicle is at reverse gear.
    public bool TPSCollision = true;        // Collision effect when camera vehicle crashes.
    ...
    private void OnEnable() {
        ...
        // Listening camera vehicle collisions for crashing effects.
    ...
    private void Update() {
        ...
        // Early out if we don't have the camera vehicle.
    ...
    private void LateUpdate() {
        ...
        // Even if we have the camera vehicle and it's disabled, return.
    ...
    /// <summary>
    /// Receiving camera inputs for orbiting the camera and zoom.
    /// </summary>
    private void Inputs() {
        ...
        //  Adjusting zoom scroll with camera inputs.
    ...
    private void TPS() {
        ...
        //  Looks back if it's enabled by camera input.
        if (lookBackNow) {
        ...
        //  Make sure camera is still checking rotation of the camera vehicle.
        ...
        if (TPSLockY) {
            ...
            //  If orbit for TPS is enabled, process orbit Y. Otherwise process Y of the camera vehicle only.
            if (!useOrbitInTPSCameraMode) {
