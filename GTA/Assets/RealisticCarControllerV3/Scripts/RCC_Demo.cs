...
/// <summary>
/// A simple manager script for all demo scenes. It has an array of spawnable camera vehicles, public methods, setting new behavior modes, restart, and quit application.
/// </summary>
...
public class RCC_Demo : MonoBehaviour {
    ...
    public void Spawn() {
        ...
        // Checking if there is a camera vehicle on the scene.
        ...
        // If we have controllable vehicle by camera on scene, destroy it.
        if (lastVehicle)
