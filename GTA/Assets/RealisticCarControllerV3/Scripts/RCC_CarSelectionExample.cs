...
public class RCC_CarSelectionExample : MonoBehaviour {
    ...
    private void CreateVehicles() {
        ...
        for (int i = 0; i < RCC_DemoVehicles.Instance.vehicles.Length; i++) {
            ...
            // Spawning the vehicle with no controllable, no camera, and engine off. We don't want to let camera control the vehicle while in selection menu.
    ...
    /// <summary>
    /// Registering the spawned vehicle as camera vehicle, enabling controllable.
    /// </summary>
