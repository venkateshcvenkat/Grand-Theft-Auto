...
namespace FCG
{
    ...
    public class TrafficSystem : MonoBehaviour
    {
        ...
        public int maxVehiclesWithPlayer = 20;
        ...
        public void LoadCars(int right_Hand)
        {
            ...
            */
            ...
            if (!player)
            {
                Debug.LogWarning("You have not set the camera in the Traffic System on Inspector. This drastically decreases performance in big cities");
            }


            //DestroyImmediate(GameObject.Find("carontainer"));
        ...
        {
            if (downTowmPosition)
                return Mathf.Lerp(0.5f, 1.2f,  Vector3.Distance(camera.position, downTowmPosition.position);
