    ...
    public class MinimapItem : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if ((sizeOnMinimap.x * MinimapDataGlobal.GetMinimapItemsSizeGlobalMultiplier()) != lastRenderItemSize.x || (sizeOnMinimap.z * MinimapDataGlobal.GetMinimapItemsSizeGlobalMultiplier()) != lastRenderItemSize.z)
            {
                ...
                //Update the radius of sphere collider of this item according of this size, for playerminimap renderer input events
            ...
            //Update the execution of particles (without this, the particle system will play desordened, if this playerminimap item script is enabled or disabled)
        ...
        {
            //This method will return true if this Minimap Item sprite is being visualized by any playerminimap camera
