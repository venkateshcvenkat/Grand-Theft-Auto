    ...
    */
    ...
    public class MinimapRendererEvents : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        public virtual void OnPointerEnter(PointerEventData ped)
        {
            ...
            //Inform that pointer is in playerminimap renderer area
        ...
        public virtual void OnPointerExit(PointerEventData ped)
        {
            ...
            //Inform that pointer is not in playerminimap renderer area
        ...
        public void Update()
        {
            ...
            if (minimapRenderer.onInputOver == null)
                return;
            //If mouse is not over the playerminimap renderer area, report
        ...
        {
            //Convert mouse position in this Event Area to local position on rect transform of this playerminimap renderer
