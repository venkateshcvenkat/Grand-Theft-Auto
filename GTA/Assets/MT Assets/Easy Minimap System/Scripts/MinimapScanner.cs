    ...
    public class MinimapScanner : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            if (textureResultOfScan != null)
                if (updateTextureResultOfScanOnMinimapNow == true || scanArea != lastScanArea)
                {
                    ...
                    //Force the playerminimap scanner to display current texture 2d in variable textureResultOfScan on playerminimap
                    ...
                    //Set the size of scan in playerminimap
        ...
        public void DoScanInThisAreaOfComponentAndShowOnMinimap()
        {
            ...
            if (Application.isPlaying == false)
            {
                ...
                //Show the preview
                currentTab = 1;
                Debug.Log("The playerminimap scan in \"" + this.gameObject.name + "\" is complete! You can view it on the \"Preview\" tab.");
        ...
        {
            //This method will return true if this Minimap Scan is being visualized by any playerminimap camera
