...
namespace MTAssets.EasyMinimapSystem
{
    ...
    */
    ...
    public class MinimapRenderer : MonoBehaviour
    {
        ...
        //Private variables to refer tho the gameobjects structure of playerminimap renderer
        ...
        {
            //Data set of pools of playerminimap items
        ...
        public class CustomInspector : UnityEditor.Editor
        {
            ...
            public override void OnInspectorGUI()
            {
                ...
                script.minimapCameraToShow = (MinimapCamera)EditorGUILayout.ObjectField(new GUIContent("Minimap Camera To Show",
                        "The playerminimap camera that will be displayed by this renderer."),
                ...
                if (script.showNorthIcon == true)
                {
                    ...
                    script.autoRotateNorthIcon = EditorGUILayout.Toggle(new GUIContent("Auto Rotate",
                                "If this option is enabled, the north icon will always be rotated so that it is always rendered at a 0º angle, even if the playerminimap is rotated."),
                                script.autoRotateNorthIcon);

                    script.northIconSprite = (Sprite)EditorGUILayout.ObjectField(new GUIContent("North Icon Sprite",
                        "The sprite that will represent the north icon on this playerminimap."),
        ...
        public void Awake()
        {
            ...
            {
                //Create the playerminimap base shape
        ...
        public void Update()
        {
            ...
            //Change the render texture of this playerminimap if changed in playerminimap camera
            ...
            //Update the form of polygon collider according to current rotation method and set the size of polygon collider according to the total size of playerminimap renderer
            ...
            if (showNorthIcon == true)
            {
                ...
                //Push the north icon to far away (half of playerminimap rect size multiplied) in forward and grab it to the border of polygon collider of playerminimap renderer (put the icon in center of border of playerminimap renderer too)
            ...
            foreach (MinimapItem item in minimapItemsToHightlight)
            {
                ...
                //Associate this playerminimap item to a item of pool, if is already associated, cancel
                ...
                //If is not associated, associate this item to first playerminimap items for highlight in the GameObject pool
            ...
            //Update all data (like, sprite, color, rotation, activity etc) for each playerminimap item to highlight in border of this playerminimap renderer
            foreach (MinimapItemOfPool item in minimapItemsForHighlightPool)
            {
                //If this playerminimap item to highlight in pool, not have a associated original Minimap Item, disable the pivot of GameObject in pool and continue
                ...
                //Update the rotation of this playerminimap highlighted item, corresponding to the direction of associated Minimap Item
                ...
                //Push the highlighted icon to far away (half of playerminimap rect size multiplied) in forward and grab it to the border of polygon collider of playerminimap renderer (put the icon in center of border of playerminimap renderer too)
        ...
        {
            //If this playerminimap item already added, cancel
            if (isMinimapItemAddedToHighlight(minimapItem) == true)
                return;

            //Add a playerminimap item on list to be highlighted
            minimapItemsToHightlight.Add(minimapItem);
        }

        public void RemoveMinimapItemOfHighlight(MinimapItem minimapItem)
        {
            //Read all list of playerminimap items to be hightlited and remove the expected
        ...
        {
            //Read all list of playerminimap items to be hightlited and check if this playerminimap item already exists
            for (int i = 0; i < minimapItemsToHightlight.Count; i++)
                if (minimapItemsToHightlight[i] == minimapItem)
                    return true;
        ...
        {
            //Clear the list of playerminimap items to be highlighted
            minimapItemsToHightlight.Clear();
        }

        public int CountQuantityOfMinimapItemsInHighlight()
        {
            //Return the quantity of playerminimap items, currently in highlights
