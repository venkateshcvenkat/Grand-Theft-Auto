...
namespace MTAssets.EasyMinimapSystem
{
    ...
    */
    ...
    public class MinimapText : MonoBehaviour
    {
        ...
        public class CustomInspector : UnityEditor.Editor
        {
            public override void OnInspectorGUI()
            {
                ...
                EditorGUILayout.PrefixLabel(new GUIContent("Text To Render",
                        "The text you want to render on the playerminimap."));
                ...
                "Size at which text will be displayed on the playerminimap. Adjust the size taking into account the size of the playerminimap camera's field of view. The larger the field of view, the smaller the text will look."),
                script.fontSize);
                ...
                script.followRotationOf = (FollowRotationOf)EditorGUILayout.EnumPopup(new GUIContent("Follow Rotation Of",
                                   "Choose a GameObject for this Minimap Text to follow its rotation.\n\nThis GameObject - This playerminimap text will follow the rotation of this GameObject.\n\nCustom GameObject - This playerminimap text will follow the rotation of another GameObject of your choice."),
                ...
                if (script.followRotationOf == FollowRotationOf.CustomGameObject)
                {
                    ...
                    script.customGameObjectToFollowRotation = (Transform)EditorGUILayout.ObjectField(new GUIContent("GameObject To Follow",
                        "This playerminimap text will follow the rotation of this GameObject."),
        ...
        {
            //This method will return true if this Minimap Text is being visualized by any playerminimap camera
