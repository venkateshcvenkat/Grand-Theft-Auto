...
namespace MTAssets.EasyMinimapSystem
{
    ...
    */
    ...
    public class MinimapCompass : MonoBehaviour
    {
        ...
        //Private variables to refer tho the gameobjects structure of playerminimap compass
        ...
        public void Update()
        {
            ...
            //Update the values for playerminimap compass, if changed
            ...
            //Update all data (like, sprite, color, rotation, activity etc) for each playerminimap item to highlight in this playerminimap compass
            foreach (MinimapItemOfPool item in minimapItemsForHighlightPool)
            {
                ...
                //Calculate angle between target player position and this playerminimap item associated, and position the highlighted icon accordding to angle in compass (using positions at same height)
