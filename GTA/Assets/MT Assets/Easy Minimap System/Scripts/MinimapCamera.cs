    ...
    public class MinimapCamera : MonoBehaviour
    {
        ...
        public class CustomInspector : UnityEditor.Editor
        {
            public override void OnInspectorGUI()
            {
                ...
                script.captureMode = (CaptureMode)EditorGUILayout.EnumPopup(new GUIContent("Capture Mode",
                                    "This variable defines the mode in which the camera will capture the scene, playerminimap items, etc. Any 2D capture mode will ALWAYS be faster to process than 3D capture modes.\n\nThe 3D capture modes work like a conventional camera and will capture playerminimap items and your scene like a normal camera. This means that it will capture 3D meshes of your scene, characters and so on.\n\nBriefly: The 2D capture modes can only capture items from Minimap, such as Minimap Scanners, Minimap Items, Minimap Text, etc. The 3D capture modes can capture items from Minimap and the scenario itens of your scene, in realtime as well, like a conventional camera. Note that Minimap items will always be rendered above the items in your scene."),
                                    script.captureMode);
                ...
                script.fieldOfView = EditorGUILayout.FloatField(new GUIContent("Field Of View",
                     "The size of field of view of this Minimap Camera.\n\nKeep in mind that the larger the field of view, the more items on the playerminimap will appear smaller. Adjust carefully. Usually a large field of view can be used for full screen maps."),
                     script.fieldOfView);
                ...
                script.followRotationOf = (FollowRotationOf)EditorGUILayout.EnumPopup(new GUIContent("Follow Rotation Of",
                                    "Choose a GameObject for this Minimap component to follow its rotation.\n\nThis GameObject - This playerminimap item will follow the rotation of this GameObject.\n\nCustom GameObject - This playerminimap item will follow the rotation of another GameObject of your choice."),
                ...
                if (script.followRotationOf == FollowRotationOf.CustomGameObject)
                {
                    ...
                    script.customGameObjectToFollowRotation = (Transform)EditorGUILayout.ObjectField(new GUIContent("GameObject To Follow",
                        "This playerminimap item will follow the rotation of this GameObject."),
        ...
        public void Awake()
        {
            ...
            if (renderTexture == null)
            {
                ...
                //Create a new temporary render texture to fill this playerminimap camera
            ...
            if (renderTexture != null && tempCameraObj == null)
            {
                ...
                //Create the camera of playerminimap
