...
namespace MTAssets.EasyMinimapSystem
{
    public class Constructor : MonoBehaviour
    {
        ...
        void Start()
        {
            //Construct all playerminimap itens with delay
        ...
        IEnumerator ConstructAllMinimapComponents()
        {
            ...
            //Create the playerminimap compass
            ...
            //Create the playerminimap scanner (varios playerminimap scanners to scan entire scene using a loop)
