...
namespace MTAssets.EasyMinimapSystem
{
    public class GameController : MonoBehaviour
    {
        ...
        //Private cache to playerminimap renderer events
        ...
        {
            //Use the position of drag start and current position of drag to move the Minimap Camera of fullscreen playerminimap
        ...
        public void OnOverInMinimapRendererArea(bool isOverMinimapRendererArea, Vector3 mouseWorldPos, MinimapItem overMinimapItem)
        {
            ...
            if (isOverMinimapRendererArea == true)
            {
                ...
                //Increase size of the selected item (avoid increase size of same playerminimap item various times)
